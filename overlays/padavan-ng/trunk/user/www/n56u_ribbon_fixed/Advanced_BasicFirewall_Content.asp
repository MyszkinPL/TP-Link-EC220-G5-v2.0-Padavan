                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="fw_log_x" class="input" onchange="return change_common(this, 'FirewallConfig', 'fw_log_x')">
                                                    ...
                                                    <option value="drop" <% nvram_match_x("","fw_log_x", "drop","selected"); %>>Сброшенные</option>
                                                    <option value="accept" <% nvram_match_x("","fw_log_x", "accept","selected"); %>>Принятые</option>
                                                    <option value="both" <% nvram_match_x("","fw_log_x", "both","selected"); %>>Все</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr id="row_misc_ping">
