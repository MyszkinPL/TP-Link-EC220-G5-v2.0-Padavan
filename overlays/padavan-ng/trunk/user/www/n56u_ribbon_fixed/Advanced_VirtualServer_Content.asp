                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="input-append">
                                                    ...
                                                    <button class="btn btn-chevron" id="chevron" type="button" onclick="pullLANIPList(this);" title="Выбрать IP-адрес LAN-клиента"><i class="icon icon-chevron-down"></i></button>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <select name="vts_proto_x_0" class="span12" onchange="change_proto()">
                                                    ...
                                                    <option value="BOTH" <% nvram_match_x("","vts_proto_x_0","BOTH","selected"); %>>Все</option>
                                                    <option value="OTHER" <% nvram_match_x("","vts_proto_x_0","OTHER","selected"); %>>Другое</option>
                                                </select>
                                            </td>
                                            <td>
