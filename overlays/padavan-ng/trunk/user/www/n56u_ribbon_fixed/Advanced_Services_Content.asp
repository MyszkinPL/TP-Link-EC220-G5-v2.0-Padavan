	...
	if (support_http_ssl()){
		...
		if (mode == "2"){
			if (document.form.http_lanport.value == document.form.https_lport.value){
				alert("HTTP и HTTPS не должны использовать один порт.");
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_anon" style="display:none">
                                        ...
                                        <tr id="row_doh_conf1" style="display:none">
                                            <td colspan="2" align="left" style="text-align:left;">
                                                <span class="caption-bold">DoH-сервер 1:</span>
                                        ...
                                        <tr id="row_doh_conf2" style="display:none">
                                            <td colspan="2" align="left" style="text-align:left;">
                                                <span class="caption-bold"><#Adm_Svc_dnscrypt_options#></span>
                                        ...
                                        <tr id="row_doh_conf3" style="display:none">
                                            <td colspan="2" align="left" style="text-align:left;">
                                                <span class="caption-bold">DoH-сервер 2:</span>
                                        ...
                                        <tr id="row_doh_conf5" style="display:none">
                                            <td colspan="2" align="left" style="text-align:left;">
                                                <span class="caption-bold">DoH-сервер 3:</span>
                                        ...
                                        <tr id="row_doh_conf7" style="display:none">
                                            <td colspan="2" align="left" style="text-align:left;">
                                                <span class="caption-bold">DoH-сервер 4:</span>
                                        ...
                                        <tr id="row_zapret_service" style="display:none">
                                            <td colspan="2" style="padding: 0; border: 0;">
                                                <table height="100%" width="100%" cellpadding="0" cellspacing="0" class="table codex-zapret-panel" style="border: 0px; margin: 0px;">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="border-bottom: 0 none;">
                                                            <select name="zapret_strategy" class="input codex-zapret-profile" onchange="zapret_strategy_change(this, 1);">
                                                                <option value="" <% nvram_match_x("", "zapret_strategy", "","selected"); %>><#ZapretDefaultProfile#></option>
                                                                <option value="0" <% nvram_match_x("", "zapret_strategy", "0","selected"); %>><#ZapretStrategyProfile#> #0: базовый upstream</option>
                                                                <option value="1" <% nvram_match_x("", "zapret_strategy", "1","selected"); %>><#ZapretStrategyProfile#> #1: легкий split</option>
                                                                <option value="2" <% nvram_match_x("", "zapret_strategy", "2","selected"); %>><#ZapretStrategyProfile#> #2: fake + multisplit</option>
                                                                <option value="3" <% nvram_match_x("", "zapret_strategy", "3","selected"); %>><#ZapretStrategyProfile#> #3: fake + fakedsplit</option>
                                                                <option value="4" <% nvram_match_x("", "zapret_strategy", "4","selected"); %>><#ZapretStrategyProfile#> #4: TCP timestamp</option>
                                                                <option value="5" <% nvram_match_x("", "zapret_strategy", "5","selected"); %>><#ZapretStrategyProfile#> #5: seqovl</option>
                                                                <option value="6" <% nvram_match_x("", "zapret_strategy", "6","selected"); %>><#ZapretStrategyProfile#> #6: упор на QUIC</option>
                                                                <option value="7" <% nvram_match_x("", "zapret_strategy", "7","selected"); %>><#ZapretStrategyProfile#> #7: Discord/STUN</option>
                                                                <option value="8" <% nvram_match_x("", "zapret_strategy", "8","selected"); %>><#ZapretStrategyProfile#> #8: сбалансированный+</option>
                                                                <option value="9" <% nvram_match_x("", "zapret_strategy", "9","selected"); %>><#ZapretStrategyProfile#> #9: жесткий RU</option>
                                                            </select>
                                                            <a href="https://github.com/bol-van/zapret2" target="_blank" rel="noreferrer noopener" class="label label-info">zapret2</a>
                                                        </td>
                                                        <tr>
