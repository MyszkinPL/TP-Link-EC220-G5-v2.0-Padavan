                                        ...
                                        <tr>
                                            <td width="35%">
                                                ...
                                                <div class="input-append">
                                                    ...
                                                    <button class="btn btn-chevron" id="chevron" type="button" onclick="pullLANIPList(this);" title="Выбрать MAC-адрес Wi-Fi-клиента"><i class="icon icon-chevron-down"></i></button>
                                                </div>
                                            </td>
                                            <td width="60%">
