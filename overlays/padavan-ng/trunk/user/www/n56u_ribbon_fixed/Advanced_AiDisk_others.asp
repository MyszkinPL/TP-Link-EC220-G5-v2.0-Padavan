                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr id="row_usb3_disable" style="display:none;">
                                            ...
                                            <td>
                                                ...
                                                &nbsp;<span style="color:#888">* нужна перезагрузка</span>
                                            </td>
                                        </tr>
                                        <tr id="row_spd">
                                    ...
                                    <table width="100%" id="tbl_minidlna" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        ...
                                        <tr>
                                            ...
                                            <td width="15%">
                                                <a href="javascript:on_dms_link();" id="web_dms_link">Веб-статус</a>
                                            </td>
                                        </tr>
                                        <tr id="row_dms_src1">
                                            <th>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="input-append">
                                                    ...
                                                    <button class="btn btn-chevron" id="chevron1" type="button" onclick="pull_usb_share_list(this, 0);" title="Выбрать общий или аудио-ресурс"><i class="icon icon-chevron-down"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="row_dms_src2">
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="input-append">
                                                    ...
                                                    <button class="btn btn-chevron" id="chevron2" type="button" onclick="pull_usb_share_list(this, 1);" title="Выбрать ресурс для видео"><i class="icon icon-chevron-down"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="row_dms_src3">
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="input-append">
                                                    ...
                                                    <button class="btn btn-chevron" id="chevron3" type="button" onclick="pull_usb_share_list(this, 2);" title="Выбрать ресурс для изображений"><i class="icon icon-chevron-down"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="row_dms_dnew">
                                        ...
                                        <tr id="row_dms_root">
                                            ...
                                            <td colspan="2">
                                                <select name="dlna_root" class="input">
                                                    ...
                                                    <option value="1" <% nvram_match_x("", "dlna_root", "1", "selected"); %>>Папки</option>
                                                    <option value="2" <% nvram_match_x("", "dlna_root", "2", "selected"); %>>Музыка</option>
                                                    <option value="3" <% nvram_match_x("", "dlna_root", "3", "selected"); %>>Видео</option>
                                                    <option value="4" <% nvram_match_x("", "dlna_root", "4", "selected"); %>>Изображения</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr id="row_dms_sort">
                                    ...
                                    <table width="100%" id="tbl_trmd" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        ...
                                        <tr id="row_trmd_rport">
                                            ...
                                            <td>
                                               <a href="javascript:on_rpc_link();" id="web_rpc_link">Веб-управление</a>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table width="100%" id="tbl_aria" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        ...
                                        <tr id="row_aria_rport">
                                            ...
                                            <td>
                                               <a href="javascript:on_aria_link();" id="web_aria_link">Веб-управление</a>
                                            </td>
                                        </tr>
                                    </table>
